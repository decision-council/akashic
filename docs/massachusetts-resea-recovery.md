...
<details>
<summary>1. I do not know what the notice requires</summary>
...
<details>
<summary>2. I need to complete the Career Center Seminar</summary>
...
<details>
<summary>3. I missed a deadline or need my next appointment</summary>
...
<details>
<summary>4. I completed something, but the record or payment looks wrong</summary>
...
<details>
<summary>5. I have a denial or disqualification determination</summary>
...
<details>
<summary>6. I am waiting for a correction, decision, or hearing</summary>
...
```mermaid
flowchart TD
  notice["Read current notice"] --> determination{"Disputed determination?"}
  determination -->|Yes| appeal["Protect appeal deadline"]
  determination -->|No| task["Complete assigned MassHire step"]
  appeal --> task
  task --> verify["Verify recorded completion"]
  verify --> unresolved{"Record or payment unresolved?"}
  unresolved -->|Yes| offices["Contact MassHire and/or DUA"]
  unresolved -->|No| monitor["Monitor notices and next tasks"]
  offices --> monitor
  monitor --> weekly["Continue truthful weekly claims"]
```
